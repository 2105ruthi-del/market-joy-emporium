...
import { ShoppingCart, Search, Heart, User, Menu, Leaf } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/80 backdrop-blur-lg shadow-[var(--shadow-soft)]">
      <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 py-3">
        ...
        <div className="flex items-center gap-1 ml-auto md:ml-0">
          <button className="hidden sm:inline-flex p-2 rounded-full hover:bg-secondary transition-colors" aria-label="Wishlist">
            <Heart className="h-5 w-5" />
          </button>
          <Link to="/login" className="hidden sm:inline-flex p-2 rounded-full hover:bg-secondary transition-colors" aria-label="Account">
